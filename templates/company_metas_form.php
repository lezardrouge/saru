...
?>
<div class="span5">
	<h1>Editer une metadonnée d'entreprise</h1>
	<p><a href="company_metas.php" class="no_underline"><img src="images/back.png" alt="&lt;&lt;" class="icon">Retour à la liste</a></p>
	<?php echo Utils::displayMessage("Les champs notés * sont obligatoires.", TYPE_MSG_INFO); ?>
	<?php echo $message; ?>
	<form method="post" action="company_metas.php">
	...
	<table class="tform">
		...
		<tr>
			...
			<td><input type="text" name="meta_order" id="meta_order" class="input-mini" value="<?php echo $meta->getOrder(); ?>"></td>
		</tr>
<?php if($meta->getId() != 0) : ?>
		<tr>
			<td>Activé</td>
...
<?php endif; ?>
	...
	<input type="submit" name="submitform" value="Ok" class="btn btn-info"> <input type="button" name="annul" class="btn" value="Annuler" onclick="window.location='company_metas.php?p=<?php echo $p; ?>'">
